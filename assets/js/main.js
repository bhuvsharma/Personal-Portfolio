...
sr.reveal('.about__info',{interval:200})
sr.reveal('.about__description',{delay:400})
sr.reveal('.skills__content',{delay:200})
sr.reveal('.qualification__rounder',{delay:200})
sr.reveal('.qualification__line',{delay:200})
sr.reveal('.qualification_title',{delay:100})
sr.reveal('.qualification__subtitle',{delay:200})
sr.reveal('.qualification__calendar ',{delay:200})
sr.reveal('.s',{delay:200})
sr.reveal('.project_title',{delay:100})
...
// sr.reveal('.footer__title',{delay:200, distance: '60px'})
// sr.reveal('.footer__subtitle',{delay:200})
sr.reveal('.footer__links',{interval:200})
